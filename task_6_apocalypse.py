...
# Really dont want to re-write stuff, so left it here.
...
# Depicts whether the game ends or continues
def game_over():
...
# Adds penalty points to player/AI
def penalty_add(player):
    split_board = penaltyScore.split(" ")
...
# Kick-ass name.  Allows clicking in GUI for simplistic user-control.
def clicky(x, y):
...
# Depicts the AI's movement.  Is usually stupid, but sometimes wins.
def ai_move():
